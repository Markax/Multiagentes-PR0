...
public class AgenteDemoJFrame extends javax.swing.JFrame {
    private AgenteEsqueleto agenteEsqueleto;
    ...
    public AgenteDemoJFrame(AgenteEsqueleto myAgent){
        initComponents();
        this.agenteEsqueleto = myAgent;
        
        this.setTitle(this.agenteEsqueleto.getName());
    }
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        ...
        if ( this.agenteEsqueleto != null)
         finalizacion = new FinalizacionDialog(this, true, agenteEsqueleto);
