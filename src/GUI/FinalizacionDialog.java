...
public class FinalizacionDialog extends javax.swing.JDialog {
    ...
    public FinalizacionDialog(java.awt.Frame parent, boolean modal, AgenteEsqueleto agenteEsqueleto) {
        super(parent, modal);
        initComponents();
        this.agenteEsqueleto = agenteEsqueleto;
        this.setTitle("Finalizar " + this.agenteEsqueleto.getName());
    }
